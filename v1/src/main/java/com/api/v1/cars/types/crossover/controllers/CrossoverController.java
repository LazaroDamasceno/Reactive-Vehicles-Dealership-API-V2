package com.api.v1.cars.types.crossover.controllers;

import com.api.v1.cars.dtos.CarResponseDto;
import com.api.v1.cars.types.crossover.services.CrossoverRegistrationService;
...
public class CrossoverController {
    ...
    @Autowired
    private CrossoverRegistrationService registrationService;
