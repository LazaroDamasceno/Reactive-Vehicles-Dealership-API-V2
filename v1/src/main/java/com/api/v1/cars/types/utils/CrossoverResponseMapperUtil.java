...
import com.api.v1.cars.types.domain.CrossoverEntity;
...
@Component
public class CrossoverResponseMapperUtil implements CarResponseMapper<CrossoverEntity> {

    @Override
    public CarResponseDto map(CrossoverEntity vehicle) {
